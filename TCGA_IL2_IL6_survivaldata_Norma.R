...
for (i in request_cancer) {
  ...
  count_matrix <- TCGAanalyze_Normalization(count_matrix, geneInfoHT,method =  'gcContent')
  samplesTP <- TCGAquery_SampleTypes(colnames(count_matrix), typesample = c("TP"))
  IL2 <- count_matrix["ENSG00000109471",samplesTP]
  ...
  TCGAanalyze_survival(df_IL2_hi,
                       ...
                       conf.int = FALSE,
                       color = c("Dark2"),
                       filename = paste("TCGA_NOR",i,"IL2_hi.pdf",sep = "_"))  
  ...
  TCGAanalyze_survival(df_IL2_lo,
                       ...
                       conf.int = FALSE,
                       color = c("Dark2"),
                       filename = paste("TCGA_NOR",i,"IL2_lo.pdf",sep = "_"))
  ...
  TCGAanalyze_survival(df_IL6_hi,
                       ...
                       conf.int = FALSE,
                       color = c("Dark2"),
                       filename = paste("TCGA_NOR",i,"IL6_hi.pdf",sep = "_"))
  ...
  TCGAanalyze_survival(df_IL6_lo,
                       ...
                       conf.int = FALSE,
                       color = c("Dark2"),
                       filename = paste("TCGA_NOR",i,"IL6_lo.pdf",sep = "_"))
